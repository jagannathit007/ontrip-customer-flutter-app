...
class AppThemeColors {
  ...
  // Background Colors
  static const Color bgCream = Color(0xFFFFF5ED);
...
class AppThemeStyles {
  ...
  static List<BoxShadow> shadowLight = [
    BoxShadow(
      color: AppThemeColors.shadowLight,
      blurRadius: 10,
  ...
  static List<BoxShadow> shadowMedium = [
    BoxShadow(
      color: AppThemeColors.shadowMedium,
      blurRadius: 20,
  ...
  static BoxDecoration cardDecoration({
    ...
    return BoxDecoration(
      color: color ?? AppThemeColors.white,
      borderRadius: BorderRadius.circular(radius ?? radiusXXLarge),
  ...
  static BoxDecoration inputDecoration({
    ...
    return BoxDecoration(
      ...
      border: Border.all(
        color: borderColor ?? AppThemeColors.borderOrange,
        width: 1.5,
      ),
    );
  }
  ...
  static BoxDecoration buttonDecoration({
    ...
    return BoxDecoration(
      color: color ?? AppThemeColors.primaryOrange,
